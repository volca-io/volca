import { Container, Flex, Heading, Link, ListItem, Text, UnorderedList } from '@chakra-ui/react';
  ...
  <Container maxW="6xl" py={12}>
    <Flex flexDirection="column" gap={12}>
      <Flex flexDirection="column" gap={4}>
        ...
        <Text>Last updated: November 06, 2022</Text>
      ...
      <Flex flexDirection="column" gap={4}>
        ...
        <UnorderedList>
          <ListItem>
            Application means the software code provided by the Company downloaded by You on any electronic device,
            named Volca
          </ListItem>
          <ListItem>
            Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App
          ...
          <ListItem>
            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Sveten AB,
            Spinnerigatan 7, Sundbyberg.
          </ListItem>
          <ListItem>
      ...
      <Flex flexDirection="column" gap={4}>
        ...
        <Text>When purchasing the Application, you are allowed to use the Application to create one (1) product.</Text>
        <Text>
          Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and
          Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.
        </Text>
        <Text>
          You are not allowed to share, publish or in any way reveal any part of the Application to a third party.
        </Text>
      </Flex>
      ...
      <Flex flexDirection="column" gap={4}>
        ...
        <Link href="mailto:admin@volca.io">admin@volca.io</Link>
      </Flex>
    </Flex>
  </Container>
);
