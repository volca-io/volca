...
const environments: Environments = {
  ...
  staging: {
    ...
    environmentVariables: {
      ...
      LOG_LEVEL: 'info',
      REGION: coreConfig.aws.region,
      SIGNING_KEY: `\${ssm:/${coreConfig.name}/staging/SIGNING_KEY}`,
      STRIPE_KEY: `\${ssm:/${coreConfig.name}/staging/STRIPE_KEY}`,
      STRIPE_WEBHOOK_SECRET: `\${ssm:/${coreConfig.name}/staging/STRIPE_WEBHOOK_SECRET}`,
      TEST_CARD_ENABLED: '1',
      AWS_COGNITO_USER_POOL_ID: `\${ssm:/${coreConfig.name}/staging/AWS_COGNITO_USER_POOL_ID`,
      AWS_COGNITO_APP_CLIENT_ID: `\${ssm:/${coreConfig.name}/staging/AWS_COGNITO_APP_CLIENT_ID`,
      AWS_COGNITO_IDENTITY_POOL_ID: `\${ssm:/${coreConfig.name}/staging/AWS_COGNITO_IDENTITY_POOL_ID}`,
    },
  ...
  production: {
    ...
    environmentVariables: {
      ...DEFAULT_ENVIRONMENT_VARIABLES,
      APP_DOMAIN: `\${ssm:/${coreConfig.name}/production/APP_DOMAIN}`,
      DB_PASSWORD: `\${ssm:/${coreConfig.name}/production/DB_PASSWORD}`,
      DB_USERNAME: 'postgres',
      DB_HOST: `\${ssm:/${coreConfig.name}/production/DB_HOST}`,
      ENVIRONMENT: 'production',
      FROM_EMAIL: coreConfig.fromEmail,
      LOG_LEVEL: 'info',
      REGION: coreConfig.aws.region,
      SIGNING_KEY: `\${ssm:/${coreConfig.name}/production/SIGNING_KEY}`,
      STRIPE_KEY: `\${ssm:/${coreConfig.name}/production/STRIPE_KEY}`,
      STRIPE_WEBHOOK_SECRET: `\${ssm:/${coreConfig.name}/production/STRIPE_WEBHOOK_SECRET}`,
      TEST_CARD_ENABLED: '1',
      AWS_COGNITO_USER_POOL_ID: `\${ssm:/${coreConfig.name}/production/AWS_COGNITO_USER_POOL_ID}`,
      AWS_COGNITO_APP_CLIENT_ID: `\${ssm:/${coreConfig.name}/production/AWS_COGNITO_APP_CLIENT_ID}`,
      AWS_COGNITO_IDENTITY_POOL_ID: `\${ssm:/${coreConfig.name}/production/AWS_COGNITO_IDENTITY_POOL_ID}`,
    },
    // Optional, get your dsn from senty.io for error tracking
    // sentry: {
    //   webappDsn: '',
